"""
please note that this code is not functional as I have removed the API keys
"""
...
def get_image(user_prompt, image_dimension='1024x1024', image_quality='standard', model='dall-e-3', nb_final_image=1):
...
# add specific weather types (rain, sunshine etc.)